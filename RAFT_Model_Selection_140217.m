function [params2pick, Merit, Beta, Vars2pick_main,  GetProbs, design, stats] = RAFT_Model_Selection_140217(design, use_pass_vars)
...
for mainfold=1:design.numFolds
    ...
    Vars2pick_main{mainfold}=find(varsscount>=params2use(introi));
    ...
    options.alpha=params2use(intalpha);
    options.lambda=params2use(intlambda);
    try
